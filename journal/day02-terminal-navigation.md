# Day 2: Linux terminal navigation basics

## What is a terminal/shell?
- terminal is the application that allows users to enter in text
- shell is the program inside the terminal to communicate with the operating system
- The shell for linux operating system
- The way linux manages data in the hard drive
